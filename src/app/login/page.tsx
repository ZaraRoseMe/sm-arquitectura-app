    ...
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-950 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-brand-950 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative">
          ...
          <div>
            <h1 className="text-white font-display text-5xl font-medium leading-tight mb-6">Gestión<br />de Proyectos</h1>
            <p className="text-white/60 text-lg leading-relaxed max-w-sm">Planifica, coordina y supervisa todos tus proyectos arquitectónicos en un solo lugar.</p>
          </div>
        </div>
        ...
        <div className="relative space-y-6">
          ...
          <div className="pt-2 border-t border-white/10">
            <p className="text-white/40 text-xs">
              desarrollado por{' '}
              <span className="text-white/70" style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: 'italic', fontSize: '13px' }}>ZR Nexus</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-8 text-center text-xs text-gray-400 lg:hidden">
            desarrollado por <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: 'italic' }}>ZR Nexus</span>
          </p>
        </div>
      </div>
    </div>
